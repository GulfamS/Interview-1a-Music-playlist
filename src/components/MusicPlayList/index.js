...
class MusicPlayList extends Component {
  ...
  onClickDelete = id => {
    ...
    const updatedList = playList.filter(eachPlayList => eachPlayList.id !== id)
    this.setState({playList: updatedList})
  }

  renderNoSongFoundView = () => (
    <EmptyContainer>
      <NoSongText>No Songs Found</NoSongText>
    </EmptyContainer>
  )
